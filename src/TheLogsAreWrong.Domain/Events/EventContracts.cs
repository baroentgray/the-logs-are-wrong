...
public enum RejectionReason
{
    ...
    MALFORMED_CONFIRMATION_PARAMETERS,
    CONFIRMATION_ACTIVE,
    CONFIRMATION_ALREADY_COMPLETED,
    CONFIRMATION_NO_PLAN,
    CONFIRMATION_REQUIRED_TOOL_UNAVAILABLE,
    CONFIRMATION_REQUIRED_LINE_NOISE_NOT_MET,
    MALFORMED_LINE_REPAIR_PARAMETERS,
    NO_ACTIVE_JAM,
    REPAIR_ALREADY_ACTIVE,
    MALFORMED_CONTAINMENT_RITUAL_PARAMETERS,
