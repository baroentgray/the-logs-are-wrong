...
public sealed class HostStageSevenEventExecutionTests
{
        ...
        ImmutableHashSet<ItemId>? activeTools = null)
    {
        ...
        var stageTwo = new AcceptedIntentStageExecutor().Execute(stageOne.FinalState, batch, Fx.Shift.Scheduler, ImmutableHashSet<ItemId>.Empty, LineNoiseRuntimeState.Create(stageOne.FinalState.ShiftId), Fx.Anomalies, Fx.Shift.Containment);
